...
from .view_sampler_object_centric import ViewSamplerObjectCentric, ViewSamplerObjectCentricCfg
...
VIEW_SAMPLERS: dict[str, ViewSampler[Any]] = {
    ...
    "object_centric": ViewSamplerObjectCentric,
}
