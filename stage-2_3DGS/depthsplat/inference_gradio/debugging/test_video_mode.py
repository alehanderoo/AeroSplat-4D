...
def main():
    ...
    frame_id = 60
    output_dir = "/home/sandro/thesis/code/depthsplat/inference_gradio/debugging/imgs_video"
    ...
    # Generate Synthetic Camera (same as app default)
    ...
    print("Running Inference WITH Video Generation (60 frames)...")
    # This exactly mimics the App's call when video is enabled.
    ...
    save_path = os.path.join(output_dir, "render_synth_video_mode.png")
